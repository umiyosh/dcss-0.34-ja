...
- Japanese resource: `crawl-ref/source/dat/descript/ja/branches.txt`
- Entries: 36
- Translated: 4
- Untranslated: 32
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Dungeon`
- English source: `crawl-ref/source/dat/descript/branches.txt:2`
- Japanese source: 未訳
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Temple`
- English source: `crawl-ref/source/dat/descript/branches.txt:11`
- Japanese source: 未訳
...
- English source: `crawl-ref/source/dat/descript/branches.txt:17`
- Japanese source: 未訳

### English

```text
The Orcish Mines are home to the orcs that have settled in the Dungeon, their
humanoid allies, and piles of freshly mined gold. Enterprising merchants who
sell to all comers have set up trading posts among the orcs and their brethren
to make good use of that gold.
```
...
- English source: `crawl-ref/source/dat/descript/branches.txt:24`
- Japanese source: `crawl-ref/source/dat/descript/ja/branches.txt:2`
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Lair`
- English source: `crawl-ref/source/dat/descript/branches.txt:31`
- Japanese source: `crawl-ref/source/dat/descript/ja/branches.txt:10`
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Swamp`
- English source: `crawl-ref/source/dat/descript/branches.txt:40`
- Japanese source: 未訳
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Shoals`
- English source: `crawl-ref/source/dat/descript/branches.txt:47`
- Japanese source: 未訳
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Snake Pit`
- English source: `crawl-ref/source/dat/descript/branches.txt:55`
- Japanese source: 未訳
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Spider Nest`
- English source: `crawl-ref/source/dat/descript/branches.txt:62`
- Japanese source: 未訳
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Slime Pits`
- English source: `crawl-ref/source/dat/descript/branches.txt:69`
- Japanese source: 未訳
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Vaults`
- English source: `crawl-ref/source/dat/descript/branches.txt:76`
- Japanese source: 未訳

### English

```text
The Vaults are said to be home to great treasures and sealed evils alike, its
origin known only to its guardians: the Ironbound Order. Intruders face an
organised defence of trained maneuvers, arms and arcana, animated constructs,
coerced allies, and tamed beasts, all in common cause.
```
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Crypt`
- English source: `crawl-ref/source/dat/descript/branches.txt:83`
- Japanese source: 未訳
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Tomb`
- English source: `crawl-ref/source/dat/descript/branches.txt:89`
- Japanese source: 未訳
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Hell`
- English source: `crawl-ref/source/dat/descript/branches.txt:95`
- Japanese source: 未訳
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Dis`
- English source: `crawl-ref/source/dat/descript/branches.txt:102`
- Japanese source: 未訳
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Gehenna`
- English source: `crawl-ref/source/dat/descript/branches.txt:110`
- Japanese source: 未訳
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Cocytus`
- English source: `crawl-ref/source/dat/descript/branches.txt:117`
- Japanese source: 未訳
...
- English source: `crawl-ref/source/dat/descript/branches.txt:124`
- Japanese source: 未訳
...
The all-pervading rot saps visitors' willpower.
```
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Zot`
- English source: `crawl-ref/source/dat/descript/branches.txt:131`
- Japanese source: 未訳
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Abyss`
- English source: `crawl-ref/source/dat/descript/branches.txt:139`
- Japanese source: 未訳
...
The Abyss consists of seven infinite levels. The abyssal rune of Zot can be
...
Killing monsters will warp the substance of the Abyss, eventually generating a
gateway out. Further persistence will wear holes in the Abyss, allowing descent
into deeper layers.

The fabric of the Abyss takes greater notice of the powerful; no matter how
they arrive, more experienced adventurers will find themselves drawn deeper
within the maddening expanse of that realm.
```
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Pandemonium`
- English source: `crawl-ref/source/dat/descript/branches.txt:163`
- Japanese source: 未訳
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Ziggurat`
- English source: `crawl-ref/source/dat/descript/branches.txt:181`
- Japanese source: 未訳
...
One ziggurat is guaranteed in the Depths. Tales tell of a magical item found
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Gauntlet`
- English source: `crawl-ref/source/dat/descript/branches.txt:196`
- Japanese source: 未訳

### English

```text
An elaborate complex designed to lure foolhardy adventurers seeking riches and
glory. Those who enter must choose a path through several combat arenas, each
of which contains treasure guarded by dangerous and sometimes exotic creatures.
At the end awaits a fearsome minotaur, guarding a large hoard of loot taken from
the bodies of foolish adventurers.

Long-range teleports are impossible in Gauntlets.
```
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Bazaar`
- English source: `crawl-ref/source/dat/descript/branches.txt:206`
- Japanese source: 未訳
...
place to place. The bazaars of these itinerant traders feature a number of
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Trove`
- English source: `crawl-ref/source/dat/descript/branches.txt:213`
- Japanese source: 未訳
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Necropolis`
- English source: `crawl-ref/source/dat/descript/branches.txt:223`
- Japanese source: 未訳

### English

```text
While many locales across the Dungeon are dedicated to the long-interred
restless dead, those whose remains are fresh or lost are collected in the
floating ceremonial chambers of the Necropolis. Each soul is enshrined and
tended to by the maintenance staff recreating both their lives and their moments
of death, helping visitors bid farewell to the departed. With the advent of
adventurers seeking the Orb of Zot, these realms have been repurposed: such
ghosts are blinded by rage and impossible to control, so both they and their
stolen possessions are sealed away in these realms of reconciliation.
```
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Ossuary`
- English source: `crawl-ref/source/dat/descript/branches.txt:244`
- Japanese source: 未訳
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Bailey`
- English source: `crawl-ref/source/dat/descript/branches.txt:251`
- Japanese source: 未訳

### English

```text
The bailey is the occupied and well-guarded fortress of a ruthless warlord.
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Ice Cave`
- English source: `crawl-ref/source/dat/descript/branches.txt:257`
- Japanese source: 未訳

### English

```text
The {{ if you.branch() == "Elf" or you.branch() == "Swamp" or
you.branch() == "Snake" or you.branch() == "Shoals" or you.branch() == "Spider"
then return "glacial chasm"; else return "ice cave"; end }} is a desolate cavern
shaped from solid ice and filled with the echoes of bestial howls. The intricate
carvings and statues which once lined its walls have been warped and obscured by
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Wizlab`
- English source: `crawl-ref/source/dat/descript/branches.txt:273`
- Japanese source: 未訳
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Depths`
- English source: `crawl-ref/source/dat/descript/branches.txt:283`
- Japanese source: 未訳
...
- English source: `crawl-ref/source/dat/descript/branches.txt:288`
- Japanese source: 未訳
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Arena`
- English source: `crawl-ref/source/dat/descript/branches.txt:298`
- Japanese source: 未訳

### English

```text
Okawaru's most favoured followers are granted access to the Arena to duel
against their foes.
```
...
- Resource: `crawl-ref/source/dat/descript/branches.txt`
- English key: `Crucible`
- English source: `crawl-ref/source/dat/descript/branches.txt:303`
- Japanese source: 未訳

### English

```text
The Crucible of Flesh is an infernal pit where Makhleb's most devoted and
detested alike are made to sanctify themselves in blood. No sane mortal would
ever choose to come here, and yet even victims of the Destroyer's greatest ire
may be granted passage out once more, should they mete out mutilation equal to
the demonic torturers of this realm.
```
